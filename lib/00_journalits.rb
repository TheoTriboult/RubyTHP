...
puts comptes.sort {|a, b| a.length <=> b.length}


puts "Le handler @epenser ce trouve a la #{comptes.index("@epenser")}ème position"



for i in 1..33
b = comptes.select{ |l| l.size == i} 

puts "pour #{i - 1} caractère il y a #{b.count} handle"
